      ...
      <div className="flex flex-col items-center gap-6 p-4">
        <div className="relative z-10 flex flex-col w-full max-w-screen-lg px-4 py-4 md:py-8 md:px-8">
          <div className="flex flex-col items-center justify-center mb-4 text-center">
            <h5 className="mb-2 text-lg text-black card-title md:text-xl">
              {loading ? (
                skeleton({ widthCls: 'w-40', heightCls: 'h-8' })
              ) : (
                <span className="text-white border-t-2 border-b-2 border-blue-500 opacity-100 text-base-content">
                  {header}
                </span>
              )}
            </h5>
            {loading ? (
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="text-sm text-blue-500 opacity-100 sm:text-base md:text-md hover:underline"
              >
                See All
              </a>
            )}
